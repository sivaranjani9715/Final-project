...
# Load the dataset
Guvi_DF_CLEAN = pd.read_csv('C:/Users/admin/Desktop/sivaranjani/DATA SCIENCE/project/ML projects/GUVI PROJECTS/Ratings of GUVI courses/RATINGS_OF_GUVI_COURSES_CLEANED_DATA.csv')
